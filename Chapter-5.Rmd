...
We shall be using the Circadian data. So, loading the data. 
...
Circadian <- read.csv(file.choose())
...
# If you run this directly, you shold get error message (unless you have installed the package containing the "levene")

install.packages(c("openxlsx", "car", dependecies=TRUE))
library(car)
...
Perret = read.csv(file.choose(), header = TRUE)
